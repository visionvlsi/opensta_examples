...
set_input_delay 0 -min -rise [get_ports cin*] -clock virtual_clock
set_input_delay 0 -min -fall [get_ports cin*] -clock virtual_clock
set_input_delay 0 -max -rise [get_ports cin*] -clock virtual_clock
set_input_delay 0 -max -fall [get_ports cin*] -clock virtual_clock
set_input_transition 1.5 -min -rise [get_ports cin*] 
set_input_transition 1.5 -min -fall [get_ports cin*] 
set_input_transition 1.5 -max -rise [get_ports cin*] 
set_input_transition 1.5 -max -fall [get_ports cin*] 
...
set_output_delay 40 -max -rise [get_ports sum*] -clock virtual_clock
set_output_delay 40 -max -fall [get_ports sum*] -clock virtual_clock
...
set_output_delay 40 -max -rise [get_ports co*] -clock virtual_clock
set_output_delay 40 -max -fall [get_ports co*] -clock virtual_clock
