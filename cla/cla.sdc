...
set_input_transition 5 -min -rise [get_ports A*]
set_input_transition 5 -min -fall [get_ports A*]
set_input_transition 5 -max -rise [get_ports A*]
set_input_transition 5 -max -fall [get_ports A*]
...
set_output_delay 89 -max -rise [get_ports S*] -clock virtual_clock
set_output_delay 89 -max -fall [get_ports S*] -clock virtual_clock
...
set_output_delay 89 -max -rise [get_ports cout] -clock virtual_clock
set_output_delay 89 -max -fall [get_ports cout] -clock virtual_clock
